...
> **About the makeup sessions.** These sessions fall outside the regular meeting pattern because of the instructor's scheduling constraints, and they substitute for the meetings that would otherwise have taken place at the end of the term. They are **not graded for participation** and **nothing is assessed in them**. (The team project's workshop checkpoint is due the night before session 7 and is graded whether or not you attend; see the team project below.) Their sole purpose is to give you additional time to prepare and review for the assessments that are graded. Attendance is strongly encouraged but is not part of your grade.
...
Supplementary materials for going further are placed in each week's `Optional/` folder in the course repository, or linked as *Optional* in the course schedule below. They are never assumed in class and are never assessed.
...
- A free [GitHub account](https://github.com/signup). Create it before the **Mon Sep 21** session; you do not need to create any repositories yet. Streamlit Community Cloud deploys apps from GitHub, and your team project will live in a GitHub repository.
...
Using Generative AI tools for plain English writing is strictly prohibited. All written work, such as reports, must be created in your own words. Light grammatical correction with Generative AI is permitted, and must be disclosed like any other use. Spell-checkers are permitted and need no disclosure.
...
**The project grade has three parts: the proposal and the workshop checkpoint are worth 10% each, and the final deliverable 80%.** The proposal, due early in the term, is scored pass / partial / fail on **whether you did the work — not on whether your idea turns out to be right**: a proposal whose direction we ask you to change still earns full marks if the page shows you did the thinking. The workshop checkpoint is scored the same way. It is written into your team repository's README by **Thu Oct 22, 11:59 PM**, the night before the Oct 23 workshop, whether or not your team attends. It fixes your success metric, and your app must be deployed by then, though it does not yet have to do anything.
...
**Evaluation is a required part of the final deliverable.** Each team fixes a success metric in its workshop checkpoint, due Thu Oct 22, and then reports against it: a test set of at least 20 real inputs, at least one deterministic check, one measured before-and-after number for a change the team made, and one failure the metric could not catch. This is a short section of the written report and about two minutes of the presentation.
...
- **The early deliverables** — team formation, the project proposal, and the workshop checkpoint — are capped at a **30%** deduction and are **still expected**. The deduction stops growing at 30%; a deliverable that is never submitted at all receives the full deduction and forfeits its feedback. In both cases the deduction is applied to your final project grade. Note that **the proposal and the workshop checkpoint also carry 10% of the project grade each in their own right** (see *Team project* above), and the two are independent: the grade asks whether you did the work, this deduction asks whether you did it on time.
